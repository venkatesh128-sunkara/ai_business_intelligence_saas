...
export default function Login() {
  const [email, setEmail] = useState("demo@insightiq.dev");
    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-ink-950 via-ink-900 to-indigo-950">
      <div className="w-full max-w-md">
        ...
        <div className="card p-7">
          ...
          <p className="text-sm text-slate-500 mb-5">Ask questions about your data in plain English.</p>
          ...
          <p className="text-xs text-slate-600 mt-3 text-center">
            Demo: <code className="text-slate-400">demo@insightiq.dev / demo123</code>
          </p>
        </div>
      </div>
    </div>
